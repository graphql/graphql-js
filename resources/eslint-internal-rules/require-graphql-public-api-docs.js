import { isJsdoc, parseTags } from './jsdoc-utils.js';

const requireGraphqlPublicApiDocsRule = {
  'require-graphql-public-api-docs': {
    meta: {
      schema: [],
    },
...
export { requireGraphqlPublicApiDocsRule };
