...
describe('Type predicates', () => {
  ...
  describe('isInputType', () => {
    function expectInputType(type: any) {
    ...
    function expectNonInputType(type: any) {
  ...
  describe('isOutputType', () => {
    function expectOutputType(type: any) {
    ...
    function expectNonOutputType(type: any) {
