...
export const OperationTypeNode = Object.freeze({
  QUERY: 'query',
  MUTATION: 'mutation',
...
export type OperationTypeNode = ValueTypes<typeof OperationTypeNode>;
