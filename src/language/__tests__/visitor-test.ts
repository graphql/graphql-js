...
describe('Visitor', () => {
  ...
  it('n', () => {
    ...
    expect(visited).to.deep.equal([
      ...
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'NonNullAssertion', 'nullabilityModifier', 'Field'],
      ['leave', 'NonNullAssertion', 'nullabilityModifier', 'Field'],
      ['leave', 'Field', 1, undefined],
      ['enter', 'Field', 2, undefined],
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'ErrorBoundary', 'nullabilityModifier', 'Field'],
      ['leave', 'ErrorBoundary', 'nullabilityModifier', 'Field'],
