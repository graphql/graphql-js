...
describe('Visitor', () => {
  ...
  it('visits kitchen sink', () => {
    ...
    expect(visited).to.deep.equal([
      ...
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'RequiredNullabilityModifier', 'nullabilityModifier', 'Field'],
      ['leave', 'RequiredNullabilityModifier', 'nullabilityModifier', 'Field'],
      ['leave', 'Field', 1, undefined],
      ['enter', 'Field', 2, undefined],
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'OptionalNullabilityModifier', 'nullabilityModifier', 'Field'],
      ['leave', 'OptionalNullabilityModifier', 'nullabilityModifier', 'Field'],
      ...
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'ListNullabilityModifier', 'nullabilityModifier', 'Field'],
      [
        'enter',
        'RequiredNullabilityModifier',
        'nullabilityModifier',
      ...
      ['leave', 'ListNullabilityModifier', 'nullabilityModifier', 'Field'],
