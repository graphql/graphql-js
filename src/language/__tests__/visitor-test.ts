...
describe('Visitor', () => {
  ...
  it('visits kitchen sink', () => {
    ...
    expect(visited).to.deep.equal([
      ...
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'RequiredDesignator', 'required', 'Field'],
      ['enter', 'ListNullabilityDesignator', 'element', 'RequiredDesignator'],
      ['leave', 'ListNullabilityDesignator', 'element', 'RequiredDesignator'],
      ['leave', 'RequiredDesignator', 'required', 'Field'],
      ...
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'ListNullabilityDesignator', 'required', 'Field'],
      ['enter', 'RequiredDesignator', 'element', 'ListNullabilityDesignator'],
      ['leave', 'RequiredDesignator', 'element', 'ListNullabilityDesignator'],
      ['leave', 'ListNullabilityDesignator', 'required', 'Field'],
      ...
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'OptionalDesignator', 'required', 'Field'],
      ['enter', 'ListNullabilityDesignator', 'element', 'OptionalDesignator'],
      ['leave', 'ListNullabilityDesignator', 'element', 'OptionalDesignator'],
      ['leave', 'OptionalDesignator', 'required', 'Field'],
      ...
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'ListNullabilityDesignator', 'required', 'Field'],
      ['enter', 'OptionalDesignator', 'element', 'ListNullabilityDesignator'],
      ['leave', 'OptionalDesignator', 'element', 'ListNullabilityDesignator'],
      ['leave', 'ListNullabilityDesignator', 'required', 'Field'],
