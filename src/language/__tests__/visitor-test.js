...
describe('Visitor', () => {
  ...
  it('visits kitchen sink', () => {
    ...
    expect(visited).to.deep.equal([
      ...
      ['enter', 'OperationDefinition', 0, 'Document'],
      ['enter', 'Name', 'name', 'OperationDefinition'],
      ['leave', 'Name', 'name', 'OperationDefinition'],
      ['enter', 'VariableDefinition', 0, 'OperationDefinition'],
      ...
      ['leave', 'VariableDefinition', 0, 'OperationDefinition'],
      ['enter', 'VariableDefinition', 1, 'OperationDefinition'],
      ['enter', 'Variable', 'variable', 'VariableDefinition'],
      ['enter', 'Name', 'name', 'Variable'],
      ['leave', 'Name', 'name', 'Variable'],
      ['leave', 'Variable', 'variable', 'VariableDefinition'],
      ...
      ['leave', 'VariableDefinition', 1, 'OperationDefinition'],
      ['enter', 'SelectionSet', 'selectionSet', 'OperationDefinition'],
      ['enter', 'Field', 0, 'SelectionSet'],
      ['enter', 'Name', 'alias', 'Field'],
      ['leave', 'Name', 'alias', 'Field'],
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'Argument', 0, 'Field'],
      ['enter', 'Name', 'name', 'Argument'],
      ['leave', 'Name', 'name', 'Argument'],
      ['enter', 'ListValue', 'value', 'Argument'],
      ['enter', 'IntValue', 0, 'ListValue'],
      ['leave', 'IntValue', 0, 'ListValue'],
      ['enter', 'IntValue', 1, 'ListValue'],
      ['leave', 'IntValue', 1, 'ListValue'],
      ['leave', 'ListValue', 'value', 'Argument'],
      ['leave', 'Argument', 0, 'Field'],
      ['enter', 'SelectionSet', 'selectionSet', 'Field'],
      ['enter', 'Field', 0, 'SelectionSet'],
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['leave', 'Field', 0, 'SelectionSet'],
      ['enter', 'InlineFragment', 1, 'SelectionSet'],
      ['enter', 'NamedType', 'typeCondition', 'InlineFragment'],
      ['enter', 'Name', 'name', 'NamedType'],
      ['leave', 'Name', 'name', 'NamedType'],
      ['leave', 'NamedType', 'typeCondition', 'InlineFragment'],
      ['enter', 'Directive', 0, 'InlineFragment'],
      ['enter', 'Name', 'name', 'Directive'],
      ['leave', 'Name', 'name', 'Directive'],
      ['leave', 'Directive', 0, 'InlineFragment'],
      ...
      ['leave', 'Argument', 1, 'Field'],
      ['enter', 'Directive', 0, 'Field'],
      ['enter', 'Name', 'name', 'Directive'],
      ['leave', 'Name', 'name', 'Directive'],
      ['enter', 'Argument', 0, 'Directive'],
      ['enter', 'Name', 'name', 'Argument'],
      ['leave', 'Name', 'name', 'Argument'],
      ['enter', 'Variable', 'value', 'Argument'],
      ['enter', 'Name', 'name', 'Variable'],
      ['leave', 'Name', 'name', 'Variable'],
      ['leave', 'Variable', 'value', 'Argument'],
      ['leave', 'Argument', 0, 'Directive'],
      ['leave', 'Directive', 0, 'Field'],
      ['enter', 'SelectionSet', 'selectionSet', 'Field'],
      ['enter', 'Field', 0, 'SelectionSet'],
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['leave', 'Field', 0, 'SelectionSet'],
      ['enter', 'FragmentSpread', 1, 'SelectionSet'],
      ['enter', 'Name', 'name', 'FragmentSpread'],
      ['leave', 'Name', 'name', 'FragmentSpread'],
      ['leave', 'FragmentSpread', 1, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'Field'],
      ['leave', 'Field', 1, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'Field'],
      ['leave', 'Field', 0, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'InlineFragment'],
      ['leave', 'InlineFragment', 1, 'SelectionSet'],
      ['enter', 'InlineFragment', 2, 'SelectionSet'],
      ['enter', 'Directive', 0, 'InlineFragment'],
      ['enter', 'Name', 'name', 'Directive'],
      ['leave', 'Name', 'name', 'Directive'],
      ['enter', 'Argument', 0, 'Directive'],
      ...
      ['leave', 'Field', 0, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'InlineFragment'],
      ['leave', 'InlineFragment', 2, 'SelectionSet'],
      ['enter', 'InlineFragment', 3, 'SelectionSet'],
      ['enter', 'SelectionSet', 'selectionSet', 'InlineFragment'],
      ['enter', 'Field', 0, 'SelectionSet'],
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ['leave', 'Field', 0, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'InlineFragment'],
      ['leave', 'InlineFragment', 3, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'Field'],
      ['leave', 'Field', 0, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'OperationDefinition'],
      ['leave', 'OperationDefinition', 0, 'Document'],
      ['enter', 'OperationDefinition', 1, 'Document'],
      ['enter', 'Name', 'name', 'OperationDefinition'],
      ['leave', 'Name', 'name', 'OperationDefinition'],
      ['enter', 'SelectionSet', 'selectionSet', 'OperationDefinition'],
      ['enter', 'Field', 0, 'SelectionSet'],
      ...
      ['leave', 'Field', 0, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'OperationDefinition'],
      ['leave', 'OperationDefinition', 1, 'Document'],
      ['enter', 'OperationDefinition', 2, 'Document'],
      ['enter', 'Name', 'name', 'OperationDefinition'],
      ['leave', 'Name', 'name', 'OperationDefinition'],
      ['enter', 'VariableDefinition', 0, 'OperationDefinition'],
      ['enter', 'Variable', 'variable', 'VariableDefinition'],
      ...
      ['leave', 'Field', 0, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'OperationDefinition'],
      ['leave', 'OperationDefinition', 2, 'Document'],
      ['enter', 'FragmentDefinition', 3, 'Document'],
      ...
      ['leave', 'Variable', 'value', 'Argument'],
      ['leave', 'Argument', 1, 'Field'],
      ['enter', 'Argument', 2, 'Field'],
      ['enter', 'Name', 'name', 'Argument'],
      ['leave', 'Name', 'name', 'Argument'],
      ['enter', 'ObjectValue', 'value', 'Argument'],
      ['enter', 'ObjectField', 0, 'ObjectValue'],
      ...
      ['leave', 'ObjectField', 0, 'ObjectValue'],
      ['enter', 'ObjectField', 1, 'ObjectValue'],
      ['enter', 'Name', 'name', 'ObjectField'],
      ['leave', 'Name', 'name', 'ObjectField'],
      ['enter', 'StringValue', 'value', 'ObjectField'],
      ['leave', 'StringValue', 'value', 'ObjectField'],
      ['leave', 'ObjectField', 1, 'ObjectValue'],
      ['leave', 'ObjectValue', 'value', 'Argument'],
      ['leave', 'Argument', 2, 'Field'],
      ['leave', 'Field', 0, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'FragmentDefinition'],
      ['leave', 'FragmentDefinition', 3, 'Document'],
      ['enter', 'OperationDefinition', 4, 'Document'],
      ['enter', 'SelectionSet', 'selectionSet', 'OperationDefinition'],
      ['enter', 'Field', 0, 'SelectionSet'],
      ['enter', 'Name', 'name', 'Field'],
      ['leave', 'Name', 'name', 'Field'],
      ...
      ['leave', 'Field', 1, 'SelectionSet'],
      ['leave', 'SelectionSet', 'selectionSet', 'OperationDefinition'],
      ['leave', 'OperationDefinition', 4, 'Document'],
