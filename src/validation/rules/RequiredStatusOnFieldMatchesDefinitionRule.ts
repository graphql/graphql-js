import type { FieldNode, NullabilityModifierNode, SupportArrayNode } from '../../language/ast';
...
import { assertListType, getNullableType, GraphQLError, GraphQLOutputType, isListType } from '../..';
...
export function RequiredStatusOnFieldMatchesDefinitionRule(
  ...
  function getDesignatorDepth(
    ...
    const getDepth: ASTReducer<number> = {
      RequiredDesignator: {
        leave({element}) { return element ?? 0 }
      },
