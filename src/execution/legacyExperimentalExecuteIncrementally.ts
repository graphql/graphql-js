...
export function legacyExperimentalExecuteIncrementally(
  args: ExecutionArgs,
): PromiseOrValue<
  | ExecutionResult
...
> {
  ...
  return legacyExperimentalExecuteQueryOrMutationOrSubscriptionEvent(
    validatedExecutionArgs,
  );
}

export function legacyExperimentalExecuteQueryOrMutationOrSubscriptionEvent(
