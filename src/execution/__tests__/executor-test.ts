...
describe('Execute: Handles basic execution tasks', () => {
  it('throws if no document is provided', () => {
    ...
    // @ts-expect-error - no document provided
  ...
  it('throws if no schema is provided', () => {
    ...
    // @ts-expect-error - no schema provided
  ...
  it('throws on invalid variables', () => {
    ...
    // @ts-expect-error - invalid variables object
  ...
  it('provides info about current execution state', () => {
    ...
    const field = (operation as OperationDefinitionNode).selectionSet
      .selections[0];
