  ...
  return { // eslint-disable-next-line new-cap
    ...
    Field: {
      ...
      leave(fieldNode) {
        ...
        const argNodes = (_fieldNode$arguments = fieldNode.arguments) !== null && _fieldNode$arguments !== void 0 ? _fieldNode$arguments : [];
        const argNodeMap = (0, _keyMap.keyMap)(argNodes, arg => arg.name.value);
        ...
        if (requiredArgs) {
          ...
          for (const argName of Object.keys(requiredArgs)) {
            if (!argNodeMap[argName]) {
              ...
              const argTypeStr = (0, _definition.isType)(argType) ? (0, _inspect.inspect)(argType) : (0, _printer.print)(argType);
              context.reportError(new _GraphQLError.GraphQLError(`Directive "@${directiveName}" argument "${argName}" of type "${argTypeStr}" is required, but it was not provided.`, directiveNode));
            }
          }
        }
      }
