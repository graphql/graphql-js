    ...
    function checkExtension(node) {
        ...
        if (expectedKind != null) {
            if (expectedKind !== node.kind) {
                ...
                context.reportError(new GraphQLError_js_1.GraphQLError(`Cannot extend non-${kindStr} type "${typeName}".`, {
            ...
            const suggestedTypes = (0, suggestionList_js_1.suggestionList)(typeName, allTypeNames);
            context.reportError(new GraphQLError_js_1.GraphQLError(`Cannot extend type "${typeName}" because it is not defined.` +
                (0, didYouMean_js_1.didYouMean)(suggestedTypes), { nodes: node.name }));
        }
    }
}
...
const defKindToExtKind = {
    ...
    [kinds_js_1.Kind.INTERFACE_TYPE_DEFINITION]: kinds_js_1.Kind.INTERFACE_TYPE_EXTENSION,
    ...
    [kinds_js_1.Kind.INPUT_OBJECT_TYPE_DEFINITION]: kinds_js_1.Kind.INPUT_OBJECT_TYPE_EXTENSION,
};
