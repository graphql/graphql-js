...
export const SYMBOL_ASYNC_ITERATOR = // $FlowFixMe[prop-missing] Flow doesn't define `Symbol.asyncIterator` yet
...
export const SYMBOL_TO_STRING_TAG = // $FlowFixMe[incompatible-type] Flow doesn't define `Symbol.toStringTag` yet
