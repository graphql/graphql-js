...
these two references resolve to the same [`parse`](/api-v17/language/parsing#parse) function:
...
- [Development Mode](/api-v17/graphql/development-mode)
- [Request Pipeline](/api-v17/graphql/request-pipeline)
- [Harness](/api-v17/graphql/harness)
- [Version](/api-v17/graphql/version)
