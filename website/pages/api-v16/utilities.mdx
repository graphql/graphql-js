...
<div className="api-category-toc">
  <p>
    <strong>Functions:</strong><br />
    <a href="/api-v16/utilities#assertvalidname">assertValidName()</a>
    <span aria-hidden="true">&middot;</span>
    <a href="/api-v16/utilities#isvalidnameerror">isValidNameError()</a>
  </p>
</div>

### Functions

#### assertValidName() <span aria-label="Deprecated" className="api-tag" title="Deprecated">Deprecated</span>
...
#### isValidNameError() <span aria-label="Deprecated" className="api-tag" title="Deprecated">Deprecated</span>
...
<div className="api-category-toc">
  <p>
    ...
    <span aria-hidden="true">&middot;</span>
    <a href="/api-v16/utilities#getoperationroottype">getOperationRootType()</a>
  </p>
</div>
...
#### getOperationRootType() <span aria-label="Deprecated" className="api-tag" title="Deprecated">Deprecated</span>
