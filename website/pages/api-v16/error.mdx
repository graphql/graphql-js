...
<div className="api-category-toc">
  ...
  <p>
    ...
    <a href="/api-v16/error#printerror">printError()</a>
    <span aria-hidden="true">&middot;</span>
    <a href="/api-v16/error#formaterror">formatError()</a>
    <span aria-hidden="true">&middot;</span>
...
#### Constructor <span aria-label="Deprecated" className="api-tag" title="Deprecated">Deprecated</span>
...
### printError() <span aria-label="Deprecated" className="api-tag" title="Deprecated">Deprecated</span>
...
### formatError() <span aria-label="Deprecated" className="api-tag" title="Deprecated">Deprecated</span>
