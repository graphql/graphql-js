...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>options?</td>
      <td><ApiType parts={[["link", "GraphQLErrorOptions", "/api-v16/error#graphqlerroroptions"]]} /></td>
      <td>Error metadata such as source locations, response path, original error, and extensions.<br />
This positional-arguments constructor overload is deprecated. Use the<br />
<code>{"GraphQLError(message, options)"}</code> overload instead.</td>
    </tr>
  </tbody>
</table>
...
#### <span className="api-deprecated-title">Constructor</span><span aria-label="Deprecated" className="api-tag" title="Deprecated"></span>
...
[`GraphQLErrorOptions`](/api-v16/error#graphqlerroroptions) object overload, which keeps optional error metadata
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>nodes?</td>
      <td><ApiType parts={[["link", "ASTNode", "/api-v16/language#astnode"], " \u007c ", ["keyword", "readonly"], " ", ["link", "ASTNode", "/api-v16/language#astnode"], "[] \u007c ", ["keyword", "null"]]} /></td>
      <td>AST node or nodes associated with this error.</td>
    </tr>
    <tr>
      <td>source?</td>
      <td><ApiType parts={[["type", "Maybe"], "\u003c", ["link", "Source", "/api-v16/language#source"], "\u003e"]} /></td>
      <td>Source document used to derive error locations.</td>
    </tr>
    <tr>
      <td>positions?</td>
      <td><ApiType parts={[["type", "Maybe"], "\u003c", ["keyword", "readonly"], " ", ["keyword", "number"], "[]\u003e"]} /></td>
      <td>Character offsets in the source document associated with<br />
this error.</td>
    </tr>
    <tr>
      <td>path?</td>
    ...
    <tr>
      ...
      <td>Original error that caused this GraphQLError, if one<br />
exists.</td>
    </tr>
    <tr>
      <td>extensions?</td>
      <td><ApiType parts={[["type", "Maybe"], "\u003c", ["link", "GraphQLErrorExtensions", "/api-v16/error#graphqlerrorextensions"], "\u003e"]} /></td>
      <td>Extension fields to include in the formatted error.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>locations</td>
      <td><ApiType parts={[["keyword", "readonly"], " ", ["link", "SourceLocation", "/api-v16/language#sourcelocation"], "[] \u007c ", ["keyword", "undefined"]]} /></td>
...
Enumerable, and appears in the result of JSON.stringify().</td>
    ...
    <tr>
      <td>nodes</td>
      <td><ApiType parts={[["keyword", "readonly"], " ", ["link", "ASTNode", "/api-v16/language#astnode"], "[] \u007c ", ["keyword", "undefined"]]} /></td>
      <td>An array of GraphQL AST Nodes corresponding to this error.</td>
    </tr>
    <tr>
      <td>source</td>
      <td><ApiType parts={[["link", "Source", "/api-v16/language#source"], " \u007c ", ["keyword", "undefined"]]} /></td>
...
which correspond to this error.</td>
    ...
    <tr>
      <td>extensions</td>
      <td><ApiType parts={[["link", "GraphQLErrorExtensions", "/api-v16/error#graphqlerrorextensions"]]} /></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><ApiType parts={[["link", "GraphQLFormattedError", "/api-v16/error#graphqlformattederror"]]} /></td>
...
### <span className="api-deprecated-title">printError()</span><span aria-label="Deprecated" className="api-tag" title="Deprecated"></span>
...
<table>
  ...
  <tbody>
    <tr>
      <td>error</td>
      <td><ApiType parts={[["link", "GraphQLError", "/api-v16/error#graphqlerror"]]} /></td>
      <td>The error to format.</td>
    </tr>
  </tbody>
</table>
...
### <span className="api-deprecated-title">formatError()</span><span aria-label="Deprecated" className="api-tag" title="Deprecated"></span>
...
<table>
  ...
  <tbody>
    <tr>
      <td><ApiType parts={[["link", "GraphQLFormattedError", "/api-v16/error#graphqlformattederror"]]} /></td>
      <td>The JSON-serializable formatted error.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>nodes</td>
      <td><ApiType parts={["\u007c ", ["link", "ASTNode", "/api-v16/language#astnode"], "\n\u007c ", ["keyword", "readonly"], " ", ["link", "ASTNode", "/api-v16/language#astnode"], "[]\n\u007c ", ["keyword", "null"], "\n\u007c ", ["keyword", "undefined"]]} /></td>
...
localization.</td>
    ...
    <tr>
      <td>locations?</td>
      <td><ApiType parts={[["keyword", "readonly"], " ", ["link", "SourceLocation", "/api-v16/language#sourcelocation"], "[]"]} /></td>
...
identify whether a null result is intentional or caused by a runtime error.</td>
    ...
    <tr>
      <td>extensions?</td>
      <td><ApiType parts={[["link", "GraphQLFormattedErrorExtensions", "/api-v16/error#graphqlformattederrorextensions"]]} /></td>
