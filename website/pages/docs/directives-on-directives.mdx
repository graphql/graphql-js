...
<Callout type="info">
  GraphQL.js v17 includes support for directives applied to directive
  definitions, directive extensions, and directive deprecation metadata.
</Callout>

GraphQL directives can now be applied to directive definitions. This is the SDL
shape introduced by the directives-on-directives proposal:
