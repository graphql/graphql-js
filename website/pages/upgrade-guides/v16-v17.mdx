...
<nav className="upgrade-guide-toc" aria-labelledby="contents">
  <div className="upgrade-guide-toc-grid">
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#using-this-guide">Using this Guide</a>
      <div className="upgrade-guide-toc-links">
        <a href="#using-this-guide">Scope and labels</a>
      </div>
    </div>
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#platform-and-package-shape">Platform and Package Shape</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#request-pipeline-and-harnesses">Request Pipeline</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#execution-and-incremental-delivery">Execution and Incremental Delivery</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#subscriptions-and-source-event-streams">Subscriptions</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#abort-signals">Runtime Features</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#input-coercion-defaults-and-custom-scalars">Input and Scalars</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#variable-values-and-resolver-info">Variables and Resolver Info</a>
      <div className="upgrade-guide-toc-links">
        <a href="#variable-values-and-resolver-info">VariableValues</a>
      </div>
    </div>
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#schema-type-system-directives-and-introspection">Schema and Introspection</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#language-ast-parser-printer-and-visitor-apis">Language and AST</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#utilities-and-error-handling">Utilities and Errors</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#practical-migration-order">Migration Work</a>
      <div className="upgrade-guide-toc-links">
