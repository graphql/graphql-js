...
<nav className="upgrade-guide-toc" aria-labelledby="contents">
  <div className="upgrade-guide-toc-grid">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#removed-utilities-and-renamed-entry-points">Removed Utilities</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#schema-construction-and-sdl">Schema and SDL</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#coercion-and-serialization">Coercion and Serialization</a>
      <div className="upgrade-guide-toc-links">
    ...
    <div className="upgrade-guide-toc-group">
      <a className="upgrade-guide-toc-title" href="#execution-and-validation">Execution and Validation</a>
      <div className="upgrade-guide-toc-links">
