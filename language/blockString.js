...
function printBlockString(value, options) {
    ...
    const forceLeadingNewLine = lines.length > 1 &&
        lines
            .slice(1)
            .every((line) => line.length === 0 || (0, characterClasses_js_1.isWhiteSpace)(line.charCodeAt(0)));
    ...
    const skipLeadingNewLine = isSingleLine && (0, characterClasses_js_1.isWhiteSpace)(value.charCodeAt(0));
