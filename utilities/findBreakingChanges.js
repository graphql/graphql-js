...
function findRemovedTypes(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function findTypesThatChangedKind(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator2 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function findArgChanges(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator3 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      try {
        for (var _iterator4 = (0, _objectValues.default)(oldFields)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
function findFieldsThatChangedTypeOnObjectOrInterfaceTypes(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator7 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
      ...
      try {
        for (var _iterator8 = (0, _objectValues.default)(oldFields)[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
...
function findFieldsThatChangedTypeOnInputObjectTypes(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator9 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
      ...
      try {
        for (var _iterator10 = (0, _objectValues.default)(oldFields)[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
      ...
      try {
        for (var _iterator11 = (0, _objectValues.default)(newFields)[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
...
function findTypesRemovedFromUnions(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator12 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
...
function findTypesAddedToUnions(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator14 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
...
function findValuesRemovedFromEnums(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator16 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
...
function findValuesAddedToEnums(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator18 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
...
function findInterfacesRemovedFromObjectTypes(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator20 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
...
function findInterfacesAddedToObjectTypes(oldSchema, newSchema) {
  ...
  try {
    for (var _iterator22 = (0, _objectValues.default)(oldTypeMap)[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
    ...
    for (var _iterator27 = oldDirectives[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
      ...
      try {
        for (var _iterator28 = newDirective.args[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
          ...
          if (oldArg === undefined && (0, _definition.isRequiredArgument)(newArg)) {
