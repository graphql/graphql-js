...
export default defineConfig(
  ...
  },
  {
    ...
    rules: {
      ...
      'internal-rules/require-public-api-exports': 'error',
      'internal-rules/require-to-string-tag': 'error',

      // `eslint-plugin-jsdoc` rule list based on `v62.9.x`.
      ...
      'jsdoc/require-description': [
        'error',
        {
          contexts: [
            ...
            {
              context: 'ClassDeclaration',
              comment: 'JsdocBlock:has(JsdocTag[tag="deprecated"])',
            },
            {
              context: 'FunctionDeclaration',
              comment: 'JsdocBlock:has(JsdocTag[tag="deprecated"])',
  ...
  },
  {
    ...
    rules: {
      ...
      'internal-rules/require-public-api-exports': 'off',
      'internal-rules/require-to-string-tag': 'off',
